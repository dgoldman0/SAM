...
def initialize_database(admin_password):
    ...
    try:
        ...
        if str(err) == "no such table: USERS":
            ...
            cur.execute("CREATE TABLE USERS(user_id INT, username TEXT NOT NULL, display_name TEXT NOT NULL, passwd TEXT NOT NULL, salt TEXT NOT NULL, admin INT DEFAULT FALSE, PRIMARY KEY(user_id));")
            salt = bcrypt.gensalt()
